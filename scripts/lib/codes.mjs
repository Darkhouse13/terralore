...
export const REMAP = { ISR: 'PSE', PSX: 'PSE' };
...
//   ESH (Western Sahara)-> SAH  (rarely present in WB data, mapped for safety)
export const wbToCanonical = { XKX: 'KOS', SSD: 'SDS', ESH: 'SAH' };
