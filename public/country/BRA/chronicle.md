# The Chronicle of Brazil: From the thousand nations of the forest and coast to a Portuguese colony built on sugar, gold, and the largest slave economy of the Americas, and on to an empire, a republic, and a modern democracy.
...
## Indigenous Peoples Before Contact — Pre-1500

For thousands of years before any European sail appeared on the horizon, the land that would become Brazil was home to hundreds of distinct nations, from the Tupi and Guarani of the coast and forests to the riverine societies of Amazonia.

- by c. 10,000 BCE: **Ancient settlement of the land** — Hunter-gatherer peoples occupy what is now Brazil over many millennia, leaving rock art and ancient sites across the interior and the northeast. [britannica-brazil, ibge-indigenous]
- 1st millennium CE: **Tupi-Guarani expansion** — Tupi-Guarani-speaking peoples spread across the Atlantic coast and into the interior, developing the farming and village societies later encountered by Europeans. [britannica-brazil]
- c. 1000 CE: **Complex Amazonian societies** — Riverine peoples of Amazonia sustain substantial settled populations, managing forests and soils on a scale long underestimated by outsiders. [britannica-brazil]
- 1500 CE: **Some thousand nations at contact** — On the eve of European arrival, perhaps two to four million people in hundreds of distinct nations inhabit the territory of present-day Brazil. [britannica-brazil, ibge-indigenous]

## Portuguese Colony: Sugar, Slavery, and Gold — 1500 - 1822

Claimed by Portugal in 1500, Brazil became a colonial society built on the export of sugar and then gold, and on the labour of millions of enslaved Africans, the largest forced migration of the Atlantic slave trade.

- April 1500: **Cabral claims Brazil for Portugal** — Pedro Alvares Cabral makes landfall on the coast near present-day Porto Seguro and claims the land for the Portuguese crown. [britannica-cabral, britannica-brazil]
- 1530s onward: **The sugar economy** — Sugar plantations and mills worked by enslaved labour rise in Pernambuco and Bahia, making Brazil a leading producer and the colony's chief source of wealth. [britannica-brazil]
- 16th-19th c.: **Transatlantic slave trade** — Brazil becomes the largest single destination of the Atlantic slave trade, receiving roughly 4.8-5 million enslaved Africans over more than three centuries. [slavevoyages, britannica-brazil]
- 1690s: **Gold rush in Minas Gerais** — The discovery of gold in the interior sets off a vast rush, founding towns such as Ouro Preto and shifting the colony's centre southward. [unesco-ouro-preto, britannica-brazil]
- 1808-1821: **The court moves to Rio** — Fleeing Napoleon, the Portuguese royal court relocates to Rio de Janeiro, which becomes the seat of the empire and is opened to wider trade. [britannica-brazil, britannica-pedro-i]

Figures:

- Pedro Alvares Cabral (c. 1467/68 - c. 1520) — Portuguese navigator. Commander of the fleet that reached the Brazilian coast in 1500 while bound for India, claiming the land for Portugal and inaugurating European colonisation of Brazil.
- Zumbi dos Palmares (1655-1695) — Leader of the Palmares quilombo. The last leader of Palmares, the great community of people who had escaped slavery in the northeast. Killed in 1695, he endures as a national symbol of resistance to slavery; the date of his death is now Black Consciousness Day.
...
- 15 Nov 1889: **Proclamation of the Republic** — A military coup led by Marshal Deodoro da Fonseca deposes Pedro II and proclaims the Republic, ending the monarchy. [britannica-deodoro, britannica-brazil]
...
- Deodoro da Fonseca (1827-1892) — First President of Brazil. Army marshal who led the 1889 coup against the monarchy and became the Republic's first head of state, resigning in 1891 after a political crisis.
...
## Modern Democratic Brazil — 1985 - present

Since 1985 Brazil has been a democracy under the Citizen Constitution of 1988, navigating hyperinflation and stabilisation, the rise of mass social programmes, corruption scandals, and sharp political polarisation as the largest nation in Latin America.

- 1988 CE: **The Citizen Constitution** — A new constitution restores full democracy and enshrines an expansive charter of civil, political, and social rights. [constitutionnet-brazil, britannica-brazil]
- 1994 CE: **Plano Real ends hyperinflation** — A new currency and stabilisation plan tame runaway inflation, reshaping the economy and politics of the 1990s. [britannica-brazil]
- 2003-2010: **Lula and social inclusion** — Luiz Inacio Lula da Silva's governments expand social programmes during a commodities boom, lifting millions out of poverty. [britannica-lula]
- 2016 CE: **Impeachment amid Lava Jato** — President Dilma Rousseff is impeached as the sweeping Car Wash corruption investigation reshapes Brazilian politics. [britannica-brazil]
- 8 Jan 2023: **Brasilia attacked, democracy holds** — Supporters of the defeated president storm the Congress, presidential palace, and Supreme Court; the institutions withstand the assault. [britannica-lula, britannica-brazil]
...
- [britannica-lula] Luiz Inacio Lula da Silva — Encyclopaedia Britannica · https://www.britannica.com/biography/Luiz-Inacio-Lula-da-Silva
...
- [nwe-brazil] Brazil — New World Encyclopedia · https://www.newworldencyclopedia.org/entry/Brazil

Citation template: Terralore, "The Chronicle of Brazil: From the thousand nations of the forest and coast to a Portuguese colony built on sugar, gold, and the largest slave economy of the Americas, and on to an empire, a republic, and a modern democracy.", terralore.co/country/BRA/chronicle, retrieved <YYYY-MM-DD>.
